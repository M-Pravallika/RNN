...
def parseArguments():
    ...
    p.add_argument('-t', '--type', help="Apply attention or not, choices: [Vanilla, Attention]", type=str, default='Attention')
    p.add_argument('-e', '--noOfEpochs', help="Max number of epochs to run", type=int, default=5)
    ...
    p.add_argument('-f', '--folder', help="Directory containing train and val folders dataset", type=str, default='dataset')
